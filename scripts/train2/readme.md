...
```
python3 -m torch.distributed.launch --nproc_per_node=1 train.py --network dope --epochs 2 --batchsize 24 --subbatchsize 10 --outf tmp/ --data ../nvisii_data_gen/output/dataset/ --gpuids 0 1 
```
